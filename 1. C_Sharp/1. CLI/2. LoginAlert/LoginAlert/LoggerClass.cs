...
namespace LoginAlert
{
    class LoggerClass
    {
        public static class Logger
        {
            ...
            private static string LogFile = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + @"\Logs\LoginAlert_" + DateTime.Now.ToString("yyyy-dd-M--HH-mm-ss") + ".log";
