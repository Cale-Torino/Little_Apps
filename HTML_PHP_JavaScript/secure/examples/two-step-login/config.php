...
$config = array(
    ...
    'pages'          => array(
        'no_login'   => array(
            '/secure/examples/two-step-login/',
            '/secure/examples/two-step-login/reset.php',
            '/secure/examples/two-step-login/register.php',
        ),
        'everyone'   => array(
            '/secure/examples/two-step-login/status.php',
        ),
        'login_page' => '/secure/examples/two-step-login/login.php',
        'home_page'  => '/secure/examples/two-step-login/home.php',
    ),
