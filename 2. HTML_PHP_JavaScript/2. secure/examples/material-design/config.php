...
$config = array(
    ...
    'pages' => array(
        'no_login'   => array(
            '/secure/examples/material-design/',
            '/secure/examples/material-design/reset.php',
            '/secure/examples/material-design/register.php',
            '/secure/examples/material-design/profile.php',
        ),
        'everyone'   => array(
            '/secure/examples/material-design/',
            '/secure/examples/material-design/index.php',
            '/secure/examples/material-design/profile.php',
        ),
        'login_page' => '/secure/examples/material-design/login.php',
        'home_page'  => '/secure/examples/material-design/home.php',
    ),
