...
public class LoggerClass {
	...
	static String Fdate = "LogFile";
    //Create log file log. file
	
	final static File AppPath = new File(RaspberryTestMain.class.getProtectionDomain().getCodeSource().getLocation().getPath());

    //private static String LogFile = AppPath.toString() + "/Logs/main_java_Test_" + Fdate + ".log";
	//private static String LogFile = AppPath.toString().substring(0, AppPath.toString().lastIndexOf("/") + 1) + "/Logs/main_java_Test_" + Fdate + ".log";
	private static String LogFile = "main_java_Test_" + Fdate + ".log";
